...
class AddNewRecipeEmptyFields(unittest.TestCase):
    def setUp(self):
    ...
    def test_add_new_recipe_empty_fields(self):
        driver = self.driver
        ...
        driver.find_element("id","input-titulo").send_keys("Receta de Arroz con leche y nata")
        ...
        self.assertEqual(u"¡Existen campos sin rellenar!", driver.find_element("id","warning-empty-id").text)
        ...
        driver.find_element("id","guardar-receta").click()
        time.sleep(1)
        self.assertEqual("Receta de Arroz con leche y nata", driver.find_element("id","receta-carta-titulo-0").text)
